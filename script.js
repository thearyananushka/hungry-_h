...
function addToCart(){
    ...
    var itemsToAdd = this.parentNode.nextSibling.nextSibling.innerText;
    var itemObj = foodItem.find(element => element.name==itemsToAdd);
    console.log(itemObj)
...
function cartItems(){
    ...
    cartData.map(item => {
        ...
        rowData4.innerText = 'Price : $' + item.price;

        // rowData4.innerText = itemPrice;
...
function totalAmount(){
    ...
    document.getElementById('total-price').innerText = 'Total Item : $' + sum;
